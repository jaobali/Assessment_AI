...
def gerar_perguntas(area: str, qtd_perguntas: int) -> List[str]:
    ...
    instructions1 = instructions1.format(area=area, qtd_perguntas=qtd_perguntas)
...
def gerar_niveis_maturidade(area: str, qtd_perguntas: int, perguntas: List[str]) -> Dict[str, List[str]]:
    """
